...
//!
//! Core built-in functions for the Lisp interpreter, organized into 13 categories with 57 total functions.
//!
//! ## Naming Convention
//!
...
//! - **[database]** (2): db-execute, db-query - SQLite database operations
